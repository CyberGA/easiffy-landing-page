...
function FAQRow({ data }: { data: IQuestion }): React.JSX.Element {
  return (
    <AccordionItem value={data.question}>
      <AccordionTrigger className="pl-2 pr-4 text-base text-left font-platypi hover:text-primary-4A ">
        {data.question}
      </AccordionTrigger>
      <AccordionContent className="px-3 text-base text-primary-dark32">
        {data.answer}
      </AccordionContent>
    </AccordionItem>
  );
      ...
      <div className="w-full max-w-6xl mx-auto">
        <div className="max-w-3xl w-full mx-auto mb-10">
          <div className="w-full mb-5">
            <h1 className="text-[40px] leading-[1] text-primary-orange61 text-center mb-10">
