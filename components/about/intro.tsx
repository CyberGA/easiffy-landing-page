...
function Intro(): React.JSX.Element {
  return (
    <section className="py-20 px-6 text-custom-dark mt-20">
      <div className="flex items-center justify-around gap-6 w-full max-w-7xl mx-auto">
        ...
        <Image src="/about-bg.jpeg" alt="About us" width={400} height={200} className="rounded-lg object-cover h-[300px]" />
      </div>
    </section>
  );
}
