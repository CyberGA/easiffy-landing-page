      ...
      <div className="overflow-hidden relative">
        <div className="flex animate-scrolling-slide">
          <h1 className="text-5xl sm:text-7xl text-secondary-gray-80/50 whitespace-nowrap font-semibold">
            Quality Product and Service Quality Product and Service Quality
            Product and Service Quality Product and Service Quality Product and
            Service Quality Product and Service
          </h1>
        </div>
      </div>
